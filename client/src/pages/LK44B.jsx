    ...
    <div className="specs-container">
      ...
      <div className="specs-block">
        ...
        {openSection === "motor" && (
          <ul className="specs-list">
            <li>{t('product.specifications.engineDetails.model')} 4M06G44/5</li>
            ...
            <li>{t('product.specifications.engineDetails.airFlow')} 2.1 m³/min</li>
            <li>{t('product.specifications.engineDetails.exhaustFlow')} 7.26 m³/min</li>
            ...
            <li>{t('product.specifications.engineDetails.enginePower')} 37 kW</li>
            ...
            <li className="sub-item">{t('product.specifications.engineDetails.fullLoad')} 9.5 L/h</li>
            <li className="sub-item">{t('product.specifications.engineDetails.load75')} 7 L/h</li>
            <li className="sub-item">{t('product.specifications.engineDetails.load50')} 4.7 L/h</li>
          </ul>
        )}
      </div>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item">
          <a href="/docs/LK44B.pdf" className="pdf-icon"><FaFilePdf /></a>
          <a href="/docs/LK44B.pdf" target="_blank" rel="noreferrer">
