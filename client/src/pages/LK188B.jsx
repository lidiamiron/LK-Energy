    ...
    <div className="specs-container">
        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>{t('product.specifications.weight')}</td><td>2050 kg</td></tr>
      ...
      <div className="specs-block">
        ...
        {openSection === "motor" && (
          <ul className="specs-list">
            <li>{t('product.specifications.engineDetails.model')} 6M11G188/5</li>
            ...
            <li>{t('product.specifications.engineDetails.airFlow')} 9.39 m³/min</li>
            <li>{t('product.specifications.engineDetails.exhaustFlow')} 9.82 m³/min</li>
            ...
            <li>{t('product.specifications.engineDetails.enginePower')} 152 kW</li>
            <li>{t('product.specifications.engineDetails.coolantCapacity')} {t('product.values.toBeDetermined')}</li>
            ...
            <li>{t('product.specifications.engineDetails.maxOilCapacity')} {t('product.values.toBeDetermined')}</li>
            <li>{t('product.specifications.engineDetails.fuelConsumption')}</li>
            <li className="sub-item">{t('product.specifications.engineDetails.fullLoad')} {t('product.values.toBeDetermined')}</li>
            <li className="sub-item">{t('product.specifications.engineDetails.load75')} {t('product.values.toBeDetermined')}</li>
            <li className="sub-item">{t('product.specifications.engineDetails.load50')} {t('product.values.toBeDetermined')}</li>
          </ul>
        )}
      </div>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item">
          <a href="/docs/LK188B.pdf" className="pdf-icon"><FaFilePdf /></a>
          <a href="/docs/LK188B.pdf" target="_blank" rel="noreferrer">
