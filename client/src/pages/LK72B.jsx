...
const ProductSpecs = () => {
  ...
  <ul className="specs-list">
    ...
    <li>Potencia bruta del motor: 60 kW</li>
  ...
  <ul className="specs-list">
    ...
    <li>Altitud: ≤1000 m</li>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item" ><a href="/docs/LK72B.pdf" className="pdf-icon"><FaFilePdf /></a>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">LK72B</h2>
        <p className="product-subtitle">Trifásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 52kW / 65kVA</li>
          <li>⚡ Potencia ESP: 57kW / 72kVA</li>
          <li>🔌 Trifásico</li>
          <li>⚖️ 1249 Kg</li>
