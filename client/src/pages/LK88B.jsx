...
const ProductSpecs = () => {
        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>1278 kg</td></tr>
  ...
  <ul className="specs-list">
    ...
    <li>Flujo de aire de admisión: 4.46 m³/min</li>
    <li>Flujo de gases de escape: 15.74 m³/min</li>
    ...
    <li>Potencia bruta del motor: 72 kW</li>
    <li>Capacidad del refrigerante: 8.5 L</li>
    <li>Tipo de regulador (gobernador): Electrónico</li>
    <li>Rango de operación del termostato: 72–89 °C</li>
    <li>Motor de arranque: 12 V</li>
    <li>Temperatura máxima del tanque superior: 105 °C</li>
    <li>Consumo de combustible (a 1500 rpm):</li>
    <li className="sub-item">100% de carga (potencia principal): 18.8 L/h</li>
    <li className="sub-item">75% de carga: 13.5 L/h</li>
    <li className="sub-item">50% de carga: 9.1 L/h</li>
  ...
  <ul className="specs-list">
    ...
    <li>Altitud: ≤1000 m</li>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item" ><a href="/docs/LK88B.pdf" className="pdf-icon"><FaFilePdf /></a>
    ...
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        ...
        <ul className="product-info">
          <li>⚡ Potencia PRP: 64kW / 80kVA</li>
          <li>⚡ Potencia ESP: 70kW / 88kVA</li>
          <li>🔌 Trifásico</li>
          <li>⚖️ 1278 Kg</li>
