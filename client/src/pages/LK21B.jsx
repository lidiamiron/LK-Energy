...
const ProductSpecs = () => {
  ...
  <ul className="specs-list">
    ...
    <li>Flujo de aire de admisión: 1.38 m³/min</li>
    <li>Flujo de gases de escape: 4.3 m³/min</li>
    ...
    <li>Potencia bruta del motor: 18 kW</li>
    ...
    <li className="sub-item">100% de carga (potencia principal): 4.7 L/h</li>
    <li className="sub-item">75% de carga: 3.6 L/h</li>
    <li className="sub-item">50% de carga: 2.6 L/h</li>
