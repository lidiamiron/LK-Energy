...
const ProductSpecs = () => {
        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Dimensiones:</td><td>2270 x 960 x 1200 mm</td></tr>
              <tr><td>Peso neto:</td><td>941 kg</td></tr>
  ...
  <ul className="specs-list">
    ...
    <li>Flujo de aire de admisión: 2.6 m³/min</li>
    <li>Flujo de gases de escape: 8.82 m³/min</li>
    ...
    <li>Potencia bruta del motor: 44 kW</li>
    <li>Capacidad del refrigerante: 3.4 L</li>
    ...
    <li className="sub-item">100% de carga (potencia principal): 10.7 L/h</li>
    <li className="sub-item">75% de carga: 8 L/h</li>
    <li className="sub-item">50% de carga: 5.4 L/h</li>
  ...
  <ul className="specs-list">
    ...
    <li>Altitud: ≤1000 m</li>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item" ><a href="/docs/LK50B.pdf" className="pdf-icon"><FaFilePdf /></a>
    ...
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        ...
        <ul className="product-info">
          <li>⚡ Potencia PRP: 36kW / 45kVA</li>
          <li>⚡ Potencia ESP: 40kW / 50kVA</li>
          <li>🔌 Trifásico</li>
          <li>⚖️ 941 Kg</li>
