...
const ProductSpecs = () => {
        ...
        {openSection === "estructura" && (
          <table className="specs-table">
            <tbody>
              ...
              <tr><td>Peso neto:</td><td>1994 kg</td></tr>
  ...
  <ul className="specs-list">
    ...
    <li>Flujo de aire de admisión: 8.65 m³/min</li>
    <li>Flujo de gases de escape: 21.8 m³/min</li>
    ...
    <li>Potencia bruta del motor: 138 kW</li>
    ...
    <li className="sub-item">100% de carga (potencia principal): 32.6 L/h</li>
    <li className="sub-item">75% de carga: 24.6 L/h</li>
    <li className="sub-item">50% de carga: 16.7 L/h</li>
  ...
  <ul className="specs-list">
    ...
    <li>Altitud: ≤1000 m</li>
      ...
      <div className="docs-block">
        ...
        <div className="doc-item" ><a href="/docs/LK165B.pdf" className="pdf-icon"><FaFilePdf /></a>
  ...
  return (
    <section className="gallery-section" ref={sectionRef}>
      ...
      <div className="gallery-right">
        <h2 className="product-title">LK165B</h2>
        <p className="product-subtitle">Trifásico</p>
        <ul className="product-info">
          <li>⚡ Potencia PRP: 120kW / 150kVA</li>
          <li>⚡ Potencia ESP: 132kW / 165kVA</li>
          <li>🔌 Trifásico</li>
          <li>⚖️ 1994 Kg</li>
